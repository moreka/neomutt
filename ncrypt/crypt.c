...
int mutt_protect(struct Email *e, char *keylist, bool postpone)
{
      ...
      ((security & PGP_INLINE) == PGP_INLINE))
  {
    ...
    {
      if (query_quadoption(c_pgp_mime_auto, _("Inline PGP can't be used with attachments.  "
    ...
    {
      if ((query_quadoption(c_pgp_mime_auto, _("Inline PGP can't be used with format=flowed.  "
                                               "Revert to PGP/MIME?"))) != MUTT_YES)
      {
